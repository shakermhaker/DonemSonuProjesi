            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="inline-block px-5 py-1.5 dark:text-[#EDEDEC] border-[#19140035] hover:border-[#F53003] border text-[#1b1b18] dark:border-[#3E3E3A] dark:hover:border-[#FF4433] rounded-sm text-sm leading-normal cursor-pointer transition-colors">
                            Log Out
                        </button>
                    </form>
                @else
